      ...
      <div className="mx-auto max-w-2xl">
        ...
        <div className="mt-8 rounded-xl border border-gray-200 bg-gray-50 p-5 text-sm text-gray-700 space-y-2">
          ...
          <ul className="space-y-1.5">
            ...
            <li className="flex gap-2"><span className="shrink-0 font-bold text-red-500">+</span>버그 신고, 기능 제안은 이메일로 접수됩니다</li>
        ...
        <div className="mt-10 space-y-10">
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900">문의 유형</h2>
            <p className="mt-3 text-sm text-gray-700 leading-relaxed">
              서비스 관련 질문, 버그 신고, 기능 제안 등 어떤 내용이든 이메일로 보내주세요.
              현재 별도 이메일 저장 데이터베이스가 없어 수신된 이메일 외 보유 데이터는 없습니다.
            </p>
            <p className="mt-2 text-sm text-gray-500">
              일반 문의는 영업일 기준 3–5일 이내에 답변 드립니다.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3 text-sm text-gray-700 leading-relaxed">
              현재 MVP 단계로 소규모로 운영됩니다. 일반 문의는 영업일 기준 3–5일 이내에 처리됩니다.
            </p>
          </section>
        </div>
